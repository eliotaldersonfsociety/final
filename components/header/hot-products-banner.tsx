  ...
  return (
    <div className="w-full">
      <button
        ...
        className="flex items-center justify-center w-full py-1.5 text-sm font-medium bg-gradient-to-r from-sky-500 to-sky-700 text-white transition-colors duration-200"
      >
