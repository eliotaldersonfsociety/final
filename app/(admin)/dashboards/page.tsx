...
import { getTotalCostOfSoldItems } from "@/app/helpers/getTotalCostOfSoldItems"; // <-- ✅ Importar aquí
...
export default async function PanelPage() {
  ...
  const totalCost = await getTotalCostOfSoldItems(); // <-- ✅ Usar helper aquí
  ...
  return (
    <PanelPageClient
      ...
      totalCost={totalCost} // <-- ✅ Pasar al cliente
    />
  );
}
