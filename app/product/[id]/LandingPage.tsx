  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="bg-red-800 text-white rounded-xl shadow-lg p-8 text-center">
            ...
            <button
              onClick={handleAddToCart}
              className="bg-white text-red-800 hover:bg-gray-100 font-bold py-4 px-12 rounded-lg text-lg transition-colors duration-200"
            >
              Pide el tuyo
            </button>
          </div>
